...
This script is deprecated as of 2026-01-29.

Video content generation is now handled by the @publisher agent,
which generates ALL content files from data sources.

For reference on categorization logic, see:
.github/agents/publisher.agent.md - Video Categorization Rules

This file is kept for migration reference only and may be removed in future versions.
"""
