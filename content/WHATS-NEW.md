...
**What's new**:
- OpenAI's GPT-5.2 now available in public preview for GitHub Copilot
...
### GitHub Copilot Spaces for Faster Debugging (Dec 4, 2025)
...
### Custom Agents for Observability, IaC, and Security (Dec 3, 2025)
